...
var theColorRamp = ['#F31E1E', '#0000FF', '#008000', '#000000']; // 路线颜色预设可选值
...
// 地图相关
var theCenter = [114.066962, 22.530559]; // 中心点坐标
var theZoom = 18; //视角远近 数字

// 动画效果
var effectShow = true; // 是否展示动画
var theSpeed = 50; // 尾迹速度，当尾迹速度不等于 0 时，使用单次循环时间作为速度依据
var thePeriod = 6; // 单次循环时间，只有当尾迹速度为 0 时才能生效
var theEffWidth = 10; // 尾迹宽度
